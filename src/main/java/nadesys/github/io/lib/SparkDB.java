/*
 * @author Morad Abdel rasheed Mokhtar Ali Gill
 * @version 2.0-stable
 */
...
public class SparkDB {
    ...
    public void readFromString(String data) throws Exception {
        ...
        boolean areHeadersProcessed = false;
    ...
    public void add(ArrayList<HashMap<String, String>> in) {
        for (HashMap<String, String> cmd : in) {
            ...
            for (Entry<String, String> inputaya : cmd.entrySet()) {
                ...
                input = (input == null) || input.isEmpty() ? "0" : input;
     ...
     */
    public class HMList {
        private final LinkedHashMap<Integer, String> data = new LinkedHashMap<>();
        private int num = 0;
